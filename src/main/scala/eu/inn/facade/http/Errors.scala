...
class ErrorMessage(val httpStatus: Int, msg: String, cause: Throwable = null, val error: String = null, val _links: Option[Map[String, Any]] = None)
  extends Exception(msg, cause)
  with FailureMessage

trait UnrecoverableFailure extends FailureMessage
