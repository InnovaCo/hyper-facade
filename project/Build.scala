  ...
  override lazy val settings: Seq[Setting[_]] =
    super.settings ++ Seq(
        ...
        libraryDependencies ++= Seq(
          ...
          "eu.inn"                         %% "hyperbus"                    % "0.1.56",
          "eu.inn"                         %% "hyperbus-model"              % "0.1.56",
          "eu.inn"                         %% "hyperbus-standard-model"     % "0.1.56",
          "eu.inn"                         %% "hyperbus-transport"          % "0.1.56",
          "eu.inn"                         %% "hyperbus-t-kafka"            % "0.1.56",
          "eu.inn"                         %% "hyperbus-t-distributed-akka" % "0.1.56",
